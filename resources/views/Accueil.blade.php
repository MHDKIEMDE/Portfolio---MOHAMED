    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Prix</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#contact">Prise de contact</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <div class="my-auto">
                ...
                <h1 class="mb-0">MOHAMED
                    <span class="text-primary">KIEMDE</span>
                </h1>
                <div class="subheading mb-5">Codeur passionné, bâtisseur d’expériences web inoubliables. <br> Ici, on ne suit
                    pas les tendances, on les
                    <a href="#">crée</a>
                </div>
                <p class="mb-5" style="max-width: 450px;">
                    Je suis passionné de développement web depuis mon jeune âge et convaincu que c'est le monde de
                    demain. Toujours en quête de nouvelles connaissances, je suis constamment en apprentissage pour
                    rester à jour dans le domaine du développement web. Compétent dans le développement avec des
                    frameworks populaires tels que Laravel, je suis prêt à relever de nouveaux défis et à créer des
                    expériences web captivantes. Mon objectif est de contribuer à des projets innovants et de repousser
                    les limites de la technologie web.
                </p>
                <ul class="list-inline list-social-icons mb-0">
                    ...
                    <li class="list-inline-item">
                        <a href="https://www.linkedin.com/in/mohamed-kiemde-737136274/">
                            <span class="fa-stack fa-lg">
                                <i class="fa fa-circle fa-stack-2x"></i>
            ...
            <div class="row my-auto">
                ...
                <div class="resume-item col-md-6 col-sm-12">
                    <div class="card mx-0 p-4 mb-5"
                        ...
                        <div class="resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-laptop mr-3 text-warning"></i>Developpeur Web</h4>
                            <p>Depuis avril 2024, je suis développeur chez MASSAKA, une entreprise de communication. Je
                                m'occupe des nouvelles conceptions de sites web et de la maintenance des anciens.
                                Polyvalent, j'aborde toutes les tâches numériques chez MASSAKA, ce qui enrichit mes
                                compétences et ma polyvalence dans ce domaine dynamique.</p>
                        </div>
                ...
                <div class="resume-item col-md-6 col-sm-12">
                    <div class="card mx-0 p-4 mb-5"
                        ...
                        <div class="resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-area-chart mr-3 text-primary"></i> Stagiaire
                                Developpement Web
                            </h4>
                            <p>Entre octobre 2023 et mars 2024, au cours d'un stage de six mois en tant que développeur
                                web, j'ai été chargé du développement de deux sites et de la gestion de la maintenance
                                de leurs plateformes. Ces missions m'ont permis d'améliorer mes compétences en
                                développement web, ainsi que ma capacité à résoudre des problèmes et à assurer le bon
                                fonctionnement des applications.
                            </p>
                        </div>
                        <div class="resume-date text-md-right">
                            <span class="text-primary">Octobre 2023 - Mars 2024</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="resume-item col-md-6 col-sm-12">
                    <div class="card mx-0 p-4 mb-5"
                        style="border-color: #ffc107; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                        <div class="resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-laptop mr-3 text-warning"></i>Victoire Hackathon</h4>
                            <p>Pendant ma formation en développement web, notre équipe a gagné un hackathon organisé par
                                l'OIF, nécessitant un mois de travail acharné pour terminer notre projet de forum. Cette
                                expérience a renforcé mes compétences en gestion de projet, collaboration et
                                développement web.</p>
                        </div>
                        <div class="resume-date text-md-right">
                            <span class="text-primary">December 2023 - March 2023</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    ======================================================-->
        <section class=" d-flex flex-column" id="skills">
            <div class="p-lg-5 p-3 skill-cover">
                <h3 class="text-center text-white">Compétences en codage</h3>
                <div class="row text-center my-auto ">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="skill-item">
                            ...
                            <h2><span class="counter"> 93</span><span>%</span></h2>
                            <p>Bootstrap</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="skill-item">
                            ...
                            <h2><span class="counter"> 79 </span><span>%</span></h2>
                            <p>Laravel</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="skill-item">
                            <i class="fa-brands fa-figma fa-5x" style="color: #5C6BC0"></i>
                            <h2><span class="counter"> 79 </span><span>%</span></h2>
                            <p>Figma</p>
                        </div>
                    </div>
                ...
                <div class="main-award" id="award-box">
                    ...
                    <div class="award">
                        ...
                        <div class="award-content">
                            ...
                            <h5 class="title">Hackathon Winner</h5>
                            <p class="description">
                                Congratulations! I won a month-long hackathon in September 2023. Lorem ipsum dolor sit
                                amet, consectetur adipiscing elit. Vestibulum mattis felis vitae
                                risus pulvinar tincidunt. Nam ac venenatis enim. Aenean hendrerit justo sed.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="award">
                        ...
                        <div class="award-content">
                            ...
                            <p class="description">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum mattis felis vitae
                                risus pulvinar tincidunt. Nam ac venenatis enim. Aenean hendrerit justo sed.
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p>Our new Project every processes had become fragmented; meaning quality and
                                        service were inconsistent. This lack of standardization was adversely impacting
                                        operating costs, productivity and customer satisfaction. For several years now
                                        Payfast has worked strategically with innovations as a means of developing new
                                        solutions, products and services. In line with this vision, Success was
                                        approached to find new payments solutions to offer Payfast customers on their
                                        website, including open invoice and partial payments options.</p>
